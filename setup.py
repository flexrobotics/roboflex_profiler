...
setup(
    ...
    version='0.1.1',
    description='Roboflex Profiler Library',
    ...
    ext_modules=[CMakeExtension('roboflex/profiler/roboflex_profiler_ext')],
    cmdclass=dict(build_ext=CMakeBuild),
    py_modules=['__init__'],
    packages=['roboflex.profiler'],
    package_dir={'roboflex.profiler': 'python'}
)
